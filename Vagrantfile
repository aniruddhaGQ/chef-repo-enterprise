...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "aniruddhagq-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/gqbyaniruddha"
  #   chef.validation_client_name = "gqbyaniruddha-validator"
  #   chef.validation_key_path = ".chef/gqbyaniruddha-validator.pem"
  # end
end
